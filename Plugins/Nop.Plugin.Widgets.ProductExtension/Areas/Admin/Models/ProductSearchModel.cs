...
namespace Nop.Plugin.Widgets.ProductExtension.Areas.Admin.Models
{
    ...
    public record ProductSearchModel : BaseSearchModel
    {
        ...
        [NopResourceDisplayName("Plugins.Widgets.ProductExtension.Products.List.SearchFromWeight")]
        public decimal SearchFromWeight { get; set; }

        [NopResourceDisplayName("Plugins.Widgets.ProductExtension.Products.List.SearchToWeight")]
        public decimal SearchToWeight { get; set; }

        [NopResourceDisplayName("Plugins.Widgets.ProductExtension.Products.List.SearchNoPicture")]
        public bool SearchNoPicture { get; set; }
