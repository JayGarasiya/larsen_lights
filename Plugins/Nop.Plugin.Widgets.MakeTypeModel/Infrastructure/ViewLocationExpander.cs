...
namespace Nop.Plugin.Widgets.MakeTypeModel.Infrastructure
{
    ...
    public class ViewLocationExpander : IViewLocationExpander
    {
        ...
        public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
        {
            ...
            {
                var controllerName = context.ControllerName.Equals("CustomProduct") ? "Product" : context.ControllerName;
                return new[] { $"/Plugins/Widgets.MakeTypeModel/Areas/Admin/Views/{controllerName}/{context.ViewName}.cshtml", }.Concat(viewLocations);
            }
