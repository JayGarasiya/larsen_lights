...
/// <summary>
/// Represents Feed Google Shopping Model
/// </summary>
public record FeedGoogleShoppingModel
{
    ...
    [NopResourceDisplayName("Plugins.Feed.GoogleShopping.FileCounter")]
    public int FileCounter { get; set; }

    [NopResourceDisplayName("Plugins.Feed.GoogleShopping.PageSizeForGoogleXmlProducts")]
