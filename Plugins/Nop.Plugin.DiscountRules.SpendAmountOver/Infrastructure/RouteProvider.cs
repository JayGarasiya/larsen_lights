...
namespace Nop.Plugin.DiscountRules.SpendAmountOver.Infrastructure;

/// <summary>
/// Represents the route provider for the "SpendAmountOver" plugin.
/// </summary>
public class RouteProvider : IRouteProvider
{
    ...
    public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
    {
        ...
        endpointRouteBuilder.MapControllerRoute(
            ...
            pattern: "Admin/DiscountRulesSpentAmountOver/Configure",
            defaults: new { controller = "DiscountRulesSpentAmountOver", action = "Configure", area = AreaNames.ADMIN }
        );
    }
