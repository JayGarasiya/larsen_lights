...
public class ViewLocationExpander : IViewLocationExpander
{
    ...
    {
        if (context.Values.TryGetValue(THEME_KEY, out string theme) && context.ControllerName.Equals("PreviouslyPurchasedCatalog") && !context.IsMainPage)
        {
            viewLocations = new[] {
                    $"/Themes/{theme}/Views/Catalog/{{0}}.cshtml",
                    $"/Views/Catalog/{{0}}.cshtml",
                }
